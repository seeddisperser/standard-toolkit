...
export const SvgSubSurfaceFriend = ({
  title,
  titleId,
  ...props
  ...
  return (
    ...
    >
      ...
      <path
        d='M12 22C17.5228 22 22 17.5228 22 12H19.2727C19.2727 16.0166 16.0166 19.2727 12 19.2727C7.98338 19.2727 4.72727 16.0166 4.72727 12H2C2 17.5228 6.47715 22 12 22Z'
        fill={fillColor}
      />
