...
export type MapModeProviderProps = {
   ...
   * <MapModeProvider mapId="main-map-uuid-123">
   *   <BaseMap />
   *   <Toolbar />
   * </MapModeProvider>
   *
   * <MapModeProvider mapId="minimap-uuid-456">
   *   <BaseMap />
   * </MapModeProvider>
   * ```
   */
 ...
 * ## Instance Isolation
 *
 * Each MapModeProvider instance operates independently. Mode changes in one instance
 ...
 * <MapModeProvider mapId="main-map-uuid-abc" defaultMode="drawing">
 *   <BaseMap />
 *   <Toolbar />
 * </MapModeProvider>
 *
 * <MapModeProvider mapId="minimap-uuid-xyz" defaultMode="view">
 *   <BaseMap />
 * </MapModeProvider>
 *
