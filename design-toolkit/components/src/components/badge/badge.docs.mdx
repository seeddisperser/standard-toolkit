...
### Offset Coordinates
When composing with other components (like [Avatar](?path=/story/components-avatar--with-badge))
...
## Props
The Badge component accepts all standard HTML span attributes
...
[Github Source](https://github.com/gohypergiant/standard-toolkit/tree/main/design-toolkit/components/src/components/badge)
