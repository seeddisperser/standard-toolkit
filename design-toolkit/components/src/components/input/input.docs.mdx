...
[Docs](https://react-spectrum.adobe.com/react-aria/TextField.html#input)

[Github Source](https://github.com/gohypergiant/standard-toolkit/tree/main/design-toolkit/components/src/components/input)
...
<div class="input-container" data-size="medium" data-invalid="false">
  ...
  <button class="clear-button" aria-label="Clear input">×</button>
</div>
```
