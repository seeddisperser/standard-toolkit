...
The Options component provides several subcomponents that work together to create a complete options interface:
...
- **`Options.Section`** - Grouping container with optional header text
