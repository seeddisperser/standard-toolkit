...
The Icon component provides a provider subcomponent for consistent sizing across multiple icons:

- **`Icon.Provider`** - Context provider that sets consistent size for all child Icon components
