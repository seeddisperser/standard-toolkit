...
### Tooltip.Trigger
The element that users interact with to show the tooltip. Can be any focusable element like a button, icon, or text span.

### Tooltip.Body
The floating container that displays the tooltip content. Automatically positions itself relative to the trigger element.
