...
- **ClassificationBannerProvider** - Context provider for setting default props across multiple classification banners
...
<ClassificationBannerProvider variant="confidential">
  <ClassificationBanner />
  <ClassificationBanner />
...
[Github Source](https://github.com/gohypergiant/standard-toolkit/tree/main/design-toolkit/components/src/components/classification-banner)
