...
- **CheckboxGroup** - Container for grouping multiple checkboxes with shared configuration
...
The `Checkbox` component wraps the `Checkbox` component from `react-aria-components`.

[Docs](https://react-spectrum.adobe.com/react-aria/Checkbox.html)

[Github Source](https://github.com/gohypergiant/standard-toolkit/tree/main/design-toolkit/components/src/components/checkbox)
