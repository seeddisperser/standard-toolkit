...
The Popover component provides several subcomponents that work together to create a complete popover interface:

- **`Popover.Trigger`** - The element that triggers the popover to open
- **`Popover.Content`** - The main popover container with positioning and backdrop
- **`Popover.Title`** - Optional header text for the popover
