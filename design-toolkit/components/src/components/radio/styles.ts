...
export const RadioStyles = tv({
  slots: {
    ...
    control: [
      ...
      'group-enabled/radio:group-selected/radio:group-hover/radio:outline-accent-primary-hover group-enabled/radio:group-selected/radio:group-hover/radio:before:[background-color:var(--fg-accent-primary-hover)]',
      'group-enabled/radio:group-selected/radio:group-pressed/radio:outline-1 group-enabled/radio:group-selected/radio:group-pressed/radio:outline-accent-primary-pressed group-enabled/radio:group-selected/radio:group-pressed/radio:before:[background-color:var(--fg-accent-primary-pressed)]',
