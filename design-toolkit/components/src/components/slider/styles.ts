...
export const SliderStyles = tv({
  slots: {
    slider: [
      ...
      'orientation-horizontal:layout-inline:grid-cols-[auto_auto_1fr_auto_auto] group-orientation-horizontal/slider:layout-inline:grid-rows-1 orientation-horizontalhorizontal:layout-inline:items-center',
    ...
    track: [
      'h-full flex',
      'group-orientation-horizontal/slider:items-center group-orientation-horizontal/slider:w-full',
    ...
    trackValue: [
      ...
      'group-orientation-vertical/slider:left-1/2 group-orientation-vertical/slider:w-xxs group-orientation-vertical/slider:absolute',
    ],
  },
});

const ValueStyles = tv({
  base: 'font-display text-body-m text-default-dark flex items-center',
});

export const MinValueStyles = tv({
  extend: ValueStyles,
  base: [
...
export const MaxValueStyles = tv({
  extend: ValueStyles,
  base: [
    'order-4',
