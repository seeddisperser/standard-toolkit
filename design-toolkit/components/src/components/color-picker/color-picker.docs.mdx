...
- **ColorPicker** - Main color picker component that renders a grid of interactive color swatches
...
The `ColorPicker` component wraps the `ColorSwatchPicker` component from `react-aria-components`. [Docs](https://react-spectrum.adobe.com/react-spectrum/ColorSwatchPicker.html)
